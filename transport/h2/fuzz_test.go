...
// a single LF, matching EncodeEvent's line-splitting rules (and the
// SSE line terminator spec). Used only by FuzzEncodeEvent to derive
// the expected round-trip target.
